...
namespace Leauge_Auto_Accept
{
    ...
    {
        public static string[] currentChamp = { "Seçilmedi", "0" };
        public static string[] currentBan = { "Seçilmedi", "0" };
        public static string[] currentSpell1 = { "Seçilmedi", "0" };
        public static string[] currentSpell2 = { "Seçilmedi", "0" };
